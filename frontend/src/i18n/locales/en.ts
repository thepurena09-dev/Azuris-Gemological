...
const en = {
  ...
  verify: {
    ...
    description:
      "Enter the certificate number printed on your Azuris document to check its authenticity.",
  ...
  adminVisuals: {
    ...
    loginSectionBg: "Login Page Background",
    loginBgHint: "Set the admin login page background to match the dashboard.",
    resetLoginBg: "Reset Login Background",
    homeBgSection: "Homepage Background",
    homeBgHint: "Set the homepage hero background image. Disabled = uses the default Azuris marble.",
    resetHomeBg: "Reset to Default Background",
    homeGemsSection: "Homepage Gemstone Photos",
    homeGemsHint: "Replace the gemstone photos shown in the homepage hero (Diamond, Ruby, Sapphire, Emerald).",
    gemDiamond: "Diamond",
    gemRuby: "Ruby",
